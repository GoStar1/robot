    ...
    <div class="content-wrapper">
        ...
        <div class="content">
            <div class="row justify-content-left">
                <div class="col-md-8">
                    <form class="form" id="main-form" method="POST" action="{{ route('task.create_data') }}">
                        @csrf
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <iframe class="col-md-12 col-lg-12 col-sm-12" style="height: 400px;"
                                        src="{{route('task_data.iframe')}}?task_data_id={{$task_data_id}}"></iframe>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <label class="col-md-4 col-form-label text-md-right">TaskData</label>
                            <div class="col-md-8">
                                <select name="task_data_id" readonly class="form-control">
                                    <option value="{{$task_data_id}}">{{$task_data_name}}</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <div class="input-group">
                                    <input type="text" class="form-control" name="inRange">
